...
@Component
public class AnteproyectoRechazadoState implements EstadoProyecto{
    @Override
    ...
    public void reintentar(ProyectoGrado proyecto) {
        ...
        if (nuevoIntento >= 3) {
            ...
            proyecto.setEstado(new EnSegundaEvaluacionAnteState());
        } else if (nuevoIntento == 3) {
            proyecto.setEstado(new EnTerceraEvaluacionAnteState());
        }
